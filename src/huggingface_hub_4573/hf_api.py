...
class HfApi:
    ...
    def unlike(
        ...
        *,
        ...
        Example:
        ```python
        >>> from huggingface_hub_4573 import list_liked_repos, unlike
    ...
    def list_liked_repos(
        ...
        *,
        ...
        Example:
        ```python
        >>> from huggingface_hub_4573 import list_liked_repos
    ...
    def repo_exists(
        ...
        *,
        ...
        Examples:
            ```py
            >>> from huggingface_hub_4573 import repo_exists
    ...
    def revision_exists(
        ...
        *,
        ...
        Examples:
            ```py
            >>> from huggingface_hub_4573 import revision_exists
    ...
    def file_exists(
        ...
        *,
        ...
        Examples:
            ```py
            >>> from huggingface_hub_4573 import file_exists
    ...
    def get_paths_info(
        ...
        *,
        ...
        Example:
        ```py
        >>> from huggingface_hub_4573 import get_paths_info
    ...
    def update_collection_metadata(
        ...
        *,
        ...
        ```py
        >>> from huggingface_hub_4573 import update_collection_metadata
    ...
    def add_collection_item(
        ...
        *,
        ...
        ```py
        >>> from huggingface_hub_4573 import add_collection_item
    ...
    def delete_collection_item(
        ...
        *,
        ...
        ```py
        >>> from huggingface_hub_4573 import get_collection, delete_collection_item
    ...
    def list_pending_access_requests(
        ...
        Example:
        ```py
        >>> from huggingface_hub_4573 import list_pending_access_requests, accept_access_request
    ...
    def list_accepted_access_requests(
        ...
        Example:
        ```py
        >>> from huggingface_hub_4573 import list_accepted_access_requests
    ...
    def list_rejected_access_requests(
        ...
        Example:
        ```py
        >>> from huggingface_hub_4573 import list_rejected_access_requests
    ...
    def get_webhook(self, webhook_id: str, *, token: Union[bool, str, None] = None) -> WebhookInfo:
        ...
        Example:
            ```python
            >>> from huggingface_hub_4573 import get_webhook
    ...
    def create_webhook(
        ...
        *,
        ...
        Example:
            ...
            ```python
            >>> from huggingface_hub_4573 import create_webhook, run_job
            >>> job = run_job(
            ...     image="ubuntu",
    ...
    def enable_webhook(self, webhook_id: str, *, token: Union[bool, str, None] = None) -> WebhookInfo:
        ...
        Example:
            ```python
            >>> from huggingface_hub_4573 import enable_webhook
    ...
    def disable_webhook(self, webhook_id: str, *, token: Union[bool, str, None] = None) -> WebhookInfo:
        ...
        Example:
            ```python
            >>> from huggingface_hub_4573 import disable_webhook
    ...
    def auth_check(
        ...
        Example:
            ...
            ```python
            >>> from huggingface_hub_4573 import auth_check
            >>> from huggingface_hub_4573.utils import GatedRepoError, RepositoryNotFoundError
    ...
    def fetch_job_logs(
        ...
        *,
        ...
        Example:
            ...
            ```python
            >>> from huggingface_hub_4573 import fetch_job_logs, run_job
    ...
    def inspect_scheduled_job(
        ...
        *,
        ...
        Example:
            ...
            ```python
            >>> from huggingface_hub_4573 import inspect_job, create_scheduled_job
