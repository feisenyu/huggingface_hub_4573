...
from huggingface_hub_4573.hf_api import upload_file
...
from huggingface_hub_4573.utils import HfHubHTTPError, get_session, hf_raise_for_status, is_jinja_available, yaml_dump
...
class RepoCard:
    ...
    def __init__(self, content: str, ignore_metadata_errors: bool = False):
        ...
        Example:
            ```python
            >>> from huggingface_hub_4573.repocard import RepoCard
            >>> text = '''
            ... ---
            ... language: en
            ... license: mit
...
class ModelCard(RepoCard):
    ...
    def from_template(  # type: ignore # violates Liskov property but easier to use
        ...
        **template_kwargs,
        ...
        Example:
            ```python
            >>> from huggingface_hub_4573 import ModelCard, ModelCardData, EvalResult
...
class DatasetCard(RepoCard):
    ...
    def from_template(  # type: ignore # violates Liskov property but easier to use
        ...
        **template_kwargs,
        ...
        Example:
            ```python
            >>> from huggingface_hub_4573 import DatasetCard, DatasetCardData
...
def metadata_eval_result(
    *,
    ...
    Example:
        ```python
        >>> from huggingface_hub_4573 import metadata_eval_result
