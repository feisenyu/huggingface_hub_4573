...
from huggingface_hub_4573.utils import logging, yaml_dump
...
class ModelCardData(CardData):
    ...
    Example:
        ```python
        >>> from huggingface_hub_4573 import ModelCardData
...
def model_index_to_eval_results(model_index: list[dict[str, Any]]) -> tuple[str, list[EvalResult]]:
    ...
    Example:
        ```python
        >>> from huggingface_hub_4573.repocard_data import model_index_to_eval_results
...
def eval_results_to_model_index(model_name: str, eval_results: list[EvalResult]) -> list[dict[str, Any]]:
    ...
    Example:
        ```python
        >>> from huggingface_hub_4573.repocard_data import eval_results_to_model_index, EvalResult
