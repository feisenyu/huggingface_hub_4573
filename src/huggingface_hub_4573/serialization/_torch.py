...
def save_torch_model(
    ...
    *,
    ...
    ```py
    >>> from huggingface_hub_4573 import save_torch_model
    ...
    # Load model back
    >>> from huggingface_hub_4573 import load_torch_model  # TODO
...
def save_torch_state_dict(
    ...
    *,
    ...
    ```py
    >>> from huggingface_hub_4573 import save_torch_state_dict
    >>> model = ... # A PyTorch model
...
def load_torch_model(
    ...
    *,
    ...
    Example:
    ```python
    >>> from huggingface_hub_4573 import load_torch_model
    >>> model = ... # A PyTorch model
...
def load_state_dict_from_file(
    ...
    Example:
    ```python
    >>> from huggingface_hub_4573 import load_state_dict_from_file
