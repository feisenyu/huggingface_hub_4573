...
def parse_ratelimit_headers(headers: Mapping[str, str]) -> Optional[RateLimitInfo]:
    ...
    Example:
    ```python
    >>> from huggingface_hub_4573.utils import parse_ratelimit_headers
    >>> headers = {
...
def http_backoff(
    ...
    **kwargs,
    ...
    Example:
    ```
    >>> from huggingface_hub_4573.utils import http_backoff
...
def http_stream_backoff(
    ...
    **kwargs,
    ...
    Example:
    ```
    >>> from huggingface_hub_4573.utils import http_stream_backoff
