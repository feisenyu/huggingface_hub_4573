...
def is_pydantic_available() -> bool:
    ...
    # as it is automatically imported when doing `from huggingface_hub_4573 import ...` even if the user doesn't use it.
    #
...
def dump_environment_info() -> dict[str, Any]:
    ...
    """
    from huggingface_hub_4573 import get_token, whoami
    from huggingface_hub_4573.utils import list_credential_helpers
